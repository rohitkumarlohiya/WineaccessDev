...
@XmlType
public class MasterDataCustomModel implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4848479663277743360L;
	private Long id;
	private String name;
	...
	public MasterDataCustomModel() {
		super();
	}

	public MasterDataCustomModel(Long id, String name,

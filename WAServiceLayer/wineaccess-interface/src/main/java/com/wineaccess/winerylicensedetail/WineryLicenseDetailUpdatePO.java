...
@XmlRootElement(name = "updateWineryLicenseDetail")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType
public class WineryLicenseDetailUpdatePO extends BasePO {

	@NotEmpty(message = "UPDATE_WINERY_LICENSE_DETAIL_101")
	@Pattern(regexp = RegExConstants.DIGITS_NOT_EMPTY_STRING, message = "UPDATE_WINERY_LICENSE_DETAIL_103")
	...
	@Pattern(regexp = RegExConstants.DIGITS_EMPTY_STRING, message = "UPDATE_WINERY_LICENSE_DETAIL_104")
	private String caLicenseTypeId;

	@Pattern(regexp = RegExConstants.BOOLEAN, message = "UPDATE_WINERY_LICENSE_DETAIL_105")
	private String contractExecuted;

	@Pattern(regexp = RegExConstants.BOOLEAN, message = "UPDATE_WINERY_LICENSE_DETAIL_106")
	private String shipCompliant;

	@Pattern(regexp = RegExConstants.ALPHA_NUMERIC_NOT_EMPTY_STRING, message = "UPDATE_WINERY_LICENSE_DETAIL_107")

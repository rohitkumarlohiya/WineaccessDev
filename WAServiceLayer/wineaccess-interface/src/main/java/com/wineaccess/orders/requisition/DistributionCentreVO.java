...
@XmlType
public class DistributionCentreVO implements Serializable {
	...
	private Map<String, String> distributionCentre;
	...
	public Map<String, String> getDistributionCentre() {
		return distributionCentre;
	}

	public void setDistributionCentre(Map<String, String> location) {
		this.distributionCentre = location;
	}

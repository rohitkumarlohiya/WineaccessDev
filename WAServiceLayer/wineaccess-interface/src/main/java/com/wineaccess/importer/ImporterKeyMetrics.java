 ...
 * 
 * it will show the importer key metrics details
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType
public class ImporterKeyMetrics implements Serializable {

	private static final long serialVersionUID = -4346450422889291058L;

...
@XmlRootElement(name = "updateWineLicenseDetail")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType
public class WineLicenseDetailUpdatePO extends BasePO {

	@NotNull(message = "UPDATE_WINE_LICENSE_DETAIL_101")
	@Pattern(regexp = RegExConstants.MANDATORY_DIGITS, message = "UPDATE_WINE_LICENSE_DETAIL_102")
	...
	@Pattern(regexp = RegExConstants.DIGITS_EMPTY_STRING, message = "UPDATE_WINE_LICENSE_DETAIL_103")
	private String caLicenseTypeId;

	@Pattern(regexp = RegExConstants.BOOLEAN, message = "UPDATE_WINE_LICENSE_DETAIL_104")
	private String contractExecuted;

	@Pattern(regexp = RegExConstants.BOOLEAN, message = "UPDATE_WINE_LICENSE_DETAIL_105")
	private String shipCompliant;

	@Pattern(regexp = RegExConstants.ALPHA_NUMERIC_NOT_EMPTY_STRING, message = "UPDATE_WINE_LICENSE_DETAIL_106")
	private String shipEscrowNo;

	@Pattern(regexp = RegExConstants.ALPHA_NUMERIC_NOT_EMPTY_STRING, message = "UPDATE_WINE_LICENSE_DETAIL_107")
	private String shipCompliantProductKey;

	@Pattern(regexp = RegExConstants.DOUBLE, message = "UPDATE_WINE_LICENSE_DETAIL_108")
	private String priceToRetailer;

	@Pattern(regexp = RegExConstants.ALPHA_NUMERIC_NOT_EMPTY_STRING, message = "UPDATE_WINE_LICENSE_DETAIL_109")
